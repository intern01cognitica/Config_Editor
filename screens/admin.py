...
class AdminScreen(Screen):
    def __init__(self, **kwargs):
        ...
        top_layout = BoxLayout(orientation="vertical", padding=200, spacing=50, size_hint=(1, 0.85))
        ...
        # --- BOTTOM BUTTONS ---
        bottom_layout = BoxLayout(orientation="vertical", spacing=10, padding=50, size_hint=(1, 0.15))
    ...
    def save_data(self, instance):
        try:
            ...
            if prev_threshold != new_threshold:
                ...
                messages.append(f"Threshold updated for Camera {cam_index+1}")
